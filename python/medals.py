...
# Here is where you can implement Homework #1.
# Note that the data file you need to use is in the ..\data folder:
#     "..\\data\\Tokyo-2020-Medals.csv"

#I spent 2 hours debugging this on problem 1. Côte d'Ivoire was saved as C?te d'Ivoire in the csv file and I was getting lots of osteric errors with stack overflow recommending I install pandas to circumvent.
import csv
import sys
